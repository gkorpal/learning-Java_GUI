 ...
 * @author hp
 */
public class NumberToString extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Number to String Converter");

        jLabel2.setText("Integer");

        jLabel3.setText("Float");
...
jTextArea1.setText("Values of int, float,double and long are "+str1+" , "+str2+" , "+str3+" and "+str4+" ");
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NumberToString.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
